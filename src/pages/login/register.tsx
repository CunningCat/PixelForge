...
export default function Register() {
  ...
  return (
    <div className=" min-h-screen w-screen flex items-center justify-center overflow-auto">
      <form
        className="w-[476px] h-[582px] bg-amber-50 mt-10 rounded-2xl px-8"
      ...
      >
        ...
        <span>
          <Checkbox
            className=" mt-2 mr-2"
            onCheckedChange={() => setConfirmReading(!confirmReading)}
          />
          <label className="text-l mt-5 text-gray-500">已阅读并同意</label>
          <a href="#" className="text-l mt-5 text-blue-500">
            《用户协议》
          </a>
        </span>

        <Button
          className="w-full mt-5 bg-white hover:bg-gray-200 text-black cursor-pointer"
          type="submit"
        >
          注册
        </Button>
