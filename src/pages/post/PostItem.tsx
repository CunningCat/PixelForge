  ...
  return (
    <div className={`flex flex-col  gap-2 p-4 rounded-2xl  ${className}`}>
      <div className="postitem_author flex justify-between">
        ...
        <div
          className="text-gray-300 mr-2 cursor-pointer flex flex-col relative"
        ...
        >
          ...
          {isActive && (
            <button
              className="absolute w-25 flex justify-center items-center p-2 bg-white top-5 -right-6 cursor-pointer text-black border rounded-2xl shadow-md border-gray-200 hover:shadow-xl transition-shadow duration-300"
      ...
      >
        ...
        {item.image_url && (
          <img className="w-40" src={item.image_url} alt={item.image_url} />
        )}
